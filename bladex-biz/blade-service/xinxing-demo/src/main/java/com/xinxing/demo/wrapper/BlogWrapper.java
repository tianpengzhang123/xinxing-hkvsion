 ...
 * @since 2024-10-18
 */
public class BlogWrapper extends BaseEntityWrapper<BlogEntity, BlogVO>  {
	...
	@Override
	public BlogVO entityVO(BlogEntity blog) {
		BlogVO blogVO = Objects.requireNonNull(BeanUtil.copyProperties(blog, BlogVO.class));
